...
contract IncreaseTotalSupply_Unit_Concrete_Test is TwabController_Unit_Shared_Test {
    ...
    function test_IncreaseTotalSupply_ZeroCardinality() public whenCardinalityIsZero {
        ...
        assertEq(totalSupply.balance, increaseAmount);
    ...
    function test_IncreaseTotalSupply_NewPeriodWithCardinalityBelowMax() public whenCardinalityBelowMax whenNewPeriod {
        ...
        uint256 expectedNewBalance = totalSupplyBefore.balance + increaseAmount;
    ...
    function test_IncreaseTotalSupply_NewPeriodWithMaxCardinality() public whenMaxCardinality whenNewPeriod {
        // Get total supply account before increase balance
        AccountDetails memory totalSupplyBefore = twabController.getTotalSupplyAccount();
        // Compute expected new total supply
        uint256 expectedNewBalance = totalSupplyBefore.balance + increaseAmount;
